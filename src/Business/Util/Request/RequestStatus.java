...
public class RequestStatus {
    ...
    public static void initalizePickupRequestStatusMap() {
        ...
        pickupRequestStatusList.put( 1, "Raised by Events - Pending with NGO Manager");
        
        pickupRequestStatusList.put( 2, "Approved by NGO Manager - Pending with Transportation Manager");
        
        pickupRequestStatusList.put( 3, "Assigned to Transportation  worker - Pending for pick-up with Transportation  worker");
